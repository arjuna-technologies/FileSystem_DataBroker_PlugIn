...
public class DirectoryUpdateDataServiceFactory implements DataFlowNodeFactory
{
    public DirectoryUpdateDataServiceFactory(String name, Map<String, String> properties)
    {
        _name       = name;
