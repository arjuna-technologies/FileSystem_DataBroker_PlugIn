...
public class FileReaderDataProcessorFactory implements DataFlowNodeFactory
{
    public FileReaderDataProcessorFactory(String name, Map<String, String> properties)
    {
        _name       = name;
