...
public class PollingFileChangeDataSourceFactory implements DataFlowNodeFactory
{
    public PollingFileChangeDataSourceFactory(String name, Map<String, String> properties)
    {
        _name       = name;
